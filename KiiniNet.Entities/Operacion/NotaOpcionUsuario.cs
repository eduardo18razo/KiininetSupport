...
namespace KiiniNet.Entities.Operacion
{
    ...
    public class NotaOpcionUsuario
    {
        [DataMember]public int Id { get; set; }
        [DataMember]public int IdTipoNota { get; set; }
        [DataMember]public int IdArbolAcceso { get; set; }
        [DataMember]public int IdUsuario { get; set; }
        [DataMember]public string Nombre { get; set; }
        [DataMember]public string Contenido { get; set; }
        [DataMember]public DateTime Fecha { get; set; }
        [DataMember]public bool Habilitado { get; set; }
