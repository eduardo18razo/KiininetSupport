<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios.Master" AutoEventWireup="true" CodeBehind="FrmGraficoTicketsTipificacion.aspx.cs" Inherits="KiiniHelp.Users.Graficos.Eficiencia.FrmGraficoTicketsTipificacion" %>
...
<%@ Register Src="~/UserControls/Filtros/Graficos/Eficiencia/UcFiltrosTicketTipificacion.ascx" TagPrefix="uc1" TagName="UcFiltrosTicketTipificacion" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ol class="breadcrumb">
                ...
                <li class="active">Tickets: Top 20 Opciones</li>
            </ol>
                        ...
                        <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            <div class="module-heading">
                                <h3 class="module-title">
                                    <asp:Label runat="server" ID="lblSeccion" Text="Tickets: Top 20 Opciones" /></h3>
                            </div>
                            <p>
                                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <uc1:UcFiltrosTicketTipificacion runat="server" ID="ucFiltrosTicketTipificacion" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </p>
                        </div>
