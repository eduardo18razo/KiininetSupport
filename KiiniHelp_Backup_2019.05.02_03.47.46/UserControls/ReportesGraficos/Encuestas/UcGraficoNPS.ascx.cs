    ...
    public partial class UcGraficoNPS : UserControl
    {
        ...
        protected void btnDownload_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.Params["idArbol"] != null && Request.Params["tipoFecha"] != null && Request.Params["fi"] != null && Request.Params["ff"] != null)
                {
                    dtDatos = _servicioEncuesta.ObtenerGraficoNpsDescarga(int.Parse(Request.Params["idArbol"]), Metodos.ManejoFechas.ObtenerFechas(int.Parse(Request.Params["tipoFecha"]), Request.Params["fi"], Request.Params["ff"]));
                }
                else if (Request.Params["idArbol"] != null && Request.Params["tipoFecha"] != null)
                    dtDatos = _servicioEncuesta.ObtenerGraficoNpsDescarga(int.Parse(Request.Params["idArbol"]), Metodos.ManejoFechas.ObtenerFechas(int.Parse(Request.Params["tipoFecha"]), string.Empty, string.Empty));
