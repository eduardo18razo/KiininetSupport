...
<asp:UpdatePanel runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <div class="modal-body no-padding-top no-padding-bottom">
            <div class="row">
                <asp:Label runat="server" ID="lblPswAbierto"></asp:Label>
                <asp:HiddenField runat="server" ID="fhFallo" Value="False" />
                <div class="email">
                    <label class="sr-only" for="txtUsuario">Usuario o Correo Electrónico</label>
                    <span class="fa fa-user icon iconLogin"></span>
                    <asp:TextBox class="form-control login-email padding-30-left text-no-transform" ID="txtUsuario" placeholder="Usuario o correo electrónico" runat="server" autofocus="autofocus" />
                </div>
                <div class="password">
                    <label class="sr-only" for="txtpwd">Contraseña</label>
                    <span class="fa fa-lock icon iconLogin"></span>
                    <asp:TextBox type="password" class="form-control login-password padding-30-left text-no-transform" ID="txtpwd" placeholder="Contraseña" runat="server" TextMode="Password" autocomplete="off" />
                ...
                <div class="form-group">
                    <asp:CustomValidator ErrorMessage="" OnServerValidate="OnServerValidate" runat="server" ID="customvalidatorCaptcha"  />
                    ...
                    <asp:TextBox CssClass="form-control text-uppercase" ID="txtCaptcha" runat="server" autocomplete="off" />
                </div>
