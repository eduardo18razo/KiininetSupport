...
{
    public partial class UcFiltrosTicketCanal : UserControl, IControllerModal
    {
        ...
        {
            get { return (int)BusinessVariables.EnumGraficos.ReporteCanal; }
        ...
        {
            IdReporte = (int)BusinessVariables.EnumGraficos.ReporteCanal;
        }
