...
{
    public partial class UcFiltrosTicketOrganizacion : UserControl, IControllerModal
    {
        ...
        {
            get { return (int)BusinessVariables.EnumGraficos.ReporteOrganización; }
        ...
        {
            IdReporte = (int)BusinessVariables.EnumGraficos.ReporteOrganización;
        }
