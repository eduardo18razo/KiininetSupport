...
{
    public partial class UcFiltrosTicketEstatusAtencion : UserControl, IControllerModal
    {
        ...
        {
            get { return (int)BusinessVariables.EnumGraficos.ReporteEstatusAtención; }
        ...
        {
            IdReporte = (int)BusinessVariables.EnumGraficos.ReporteEstatusAtención;
        }
