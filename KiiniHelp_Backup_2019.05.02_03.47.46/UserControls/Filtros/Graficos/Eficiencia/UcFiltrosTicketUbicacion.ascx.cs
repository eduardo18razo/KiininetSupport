...
{
    public partial class UcFiltrosTicketUbicacion : UserControl, IControllerModal
    {
        ...
        {
            get { return (int)BusinessVariables.EnumGraficos.ReporteEstados; }
        ...
        {
            IdReporte = (int)BusinessVariables.EnumGraficos.ReporteEstados;
        }
