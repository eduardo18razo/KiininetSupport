<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios.Master" AutoEventWireup="true" CodeBehind="FrmGraficoTicketsUbicacion.aspx.cs" Inherits="KiiniHelp.Users.Graficos.Eficiencia.FrmGraficoTicketsUbicacion" %>
...
<%@ Register Src="~/UserControls/Filtros/Graficos/Eficiencia/UcFiltrosTicketUbicacion.ascx" TagPrefix="uc1" TagName="UcFiltrosTicketUbicacion" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ol class="breadcrumb">
                ...
                <li class="active">Tickets: Localización</li>
            </ol>
                        ...
                        <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            <div class="module-heading">
                                <h3 class="module-title">
                                    <asp:Label runat="server" ID="lblSeccion" Text="Tickets: Localización" /></h3>
                            </div>
                            <p>
                                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <uc1:UcFiltrosTicketUbicacion runat="server" ID="ucFiltrosTicketUbicacion" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </p>
                        </div>
