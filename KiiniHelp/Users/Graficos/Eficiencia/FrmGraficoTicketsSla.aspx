<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios.Master" AutoEventWireup="true" CodeBehind="FrmGraficoTicketsSla.aspx.cs" Inherits="KiiniHelp.Users.Graficos.Eficiencia.FrmGraficoTicketsSla" %>
...
<%@ Register Src="~/UserControls/Filtros/Graficos/Eficiencia/UcFiltrosTicketSla.ascx" TagPrefix="uc1" TagName="UcFiltrosTicketSla" %>
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <ol class="breadcrumb">
                    ...
                    <li>Graficos</li>
                    <li class="active">Tickets: Dentro y Fuera de SLA</li>
                </ol>
                            ...
                            <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                <div class="module-heading">
                                    <h3 class="module-title">
                                        <asp:Label runat="server" ID="lblSeccion" Text="Tickets: Dentro y Fuera de SLA" /></h3>
                                </div>
                                <p>
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <uc1:UcFiltrosTicketSla runat="server" id="ucFiltrosTicketSla" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </p>
                            </div>
