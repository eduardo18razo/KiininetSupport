<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios.Master" AutoEventWireup="true" CodeBehind="FrmGraficoTicketsTipoTicket.aspx.cs" Inherits="KiiniHelp.Users.Graficos.Eficiencia.FrmGraficoTicketsTipoTicket" %>
...
<%@ Register Src="~/UserControls/Filtros/Graficos/Eficiencia/UcFiltrosTicketTipoTicket.ascx" TagPrefix="uc1" TagName="UcFiltrosTicketTipoTicket" %>
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <ol class="breadcrumb">
                    ...
                    <li>Graficos</li>
                    <li class="active">Tickets: Servicio / Incidente</li>
                </ol>
                            ...
                            <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                <div class="module-heading">
                                    <h3 class="module-title">
                                        <asp:Label runat="server" ID="lblSeccion" Text="Tickets: Servicio / Incidente" /></h3>
                                </div>
                                <p>
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <uc1:UcFiltrosTicketTipoTicket runat="server" id="ucFiltrosTicketTipoTicket" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </p>
                            </div>
