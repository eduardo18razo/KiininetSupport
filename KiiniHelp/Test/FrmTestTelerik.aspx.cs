    ...
    public partial class FrmTestTelerik : System.Web.UI.Page
    {
        ...
        protected void btnAddDiaDescanso_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                DiaFeriado newDay = new DiaFeriado { Id = 0, Descripcion = txtDescripcionDia.Text, Fecha = DateTime.ParseExact(txtDate.Text, "dd/MM/yyyy", null), IdUsuarioAlta = 1 };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //lblMaquina.Text = Request.UserHostName;
