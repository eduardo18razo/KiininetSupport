                ...
                <div class="container">
                    <div class="row">
                        <div class="form-box col-md-8 col-sm-12 col-xs-12 col-md-offset-2 col-sm-offset-0 xs-offset-0">
                            <h1 class="form-box-heading2 logo text-center"><span class="highlight">Recuperar contraseña</span> </h1>
                            <div class="form-box-inner2">
                                <h2 class="title text-center">¿Cómo quieres recuperar tu contraseña?</h2>
                                <div class="row">
                                    <div class="form-container col-md-6 col-sm-12 col-xs-12 margin-bottom-25">
