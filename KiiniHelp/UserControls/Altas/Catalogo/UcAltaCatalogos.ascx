        ...
        <div class="modal-body">
            <section class="module no-border" style="border: none">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="module-inner">
                            ...
                            <div class="form-group">
                                ...
                                <ajax:AsyncFileUpload ID="afuArchivo" runat="server" disabled UploaderStyle="Traditional" OnUploadedComplete="afuArchivo_OnUploadedComplete" PersistFile="True" />
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <p class="text-right">
                            <asp:Button runat="server" CssClass="btn btn-primary" Text="Guardar" ID="btnGuardar"  />
