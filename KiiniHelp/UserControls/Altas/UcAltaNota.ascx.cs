...
{
    public partial class UcAltaNota : UserControl, IControllerModal
    {
        ...
        protected void ddlTipoNota_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                divTipoArbol.Visible = false;
                if (ddlTipoNota.SelectedIndex == BusinessVariables.ComboBoxCatalogo.IndexSeleccione)
                {
                    return;
                }
                divTipoArbol.Visible = int.Parse(ddlTipoNota.SelectedValue) != (int)BusinessVariables.EnumeradoresKiiniNet.EnumTipoNota.General;
            }
            catch (Exception ex)
            {
                if (_lstError == null)
        ...
        protected void btnGuardar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (EsAlta)
                {
                    switch (int.Parse(ddlTipoNota.SelectedValue))
                    {
                        case (int)BusinessVariables.EnumeradoresKiiniNet.EnumTipoNota.General:
                            NotaGeneral notaGeneral = new NotaGeneral
                            {
                                ...
                                Compartida = chkCompartir.Checked
                            };
                            _servicioNota.CrearNotaGeneralUsuario(notaGeneral);
                            break;
                        case (int)BusinessVariables.EnumeradoresKiiniNet.EnumTipoNota.Opcion:
