        ...
        <div class="row" runat="server" id="divData">
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                ...
                <div class="margin-top" runat="server" id="divStep3" visible="False">
                    ...
                    <br />
                    <asp:LinkButton runat="server" CssClass="btn btn-primary btn-square" ID="btnStatusNivel3" CommandArgument="3">
                    ...
                    <div>
                        <div runat="server" id="divStep1Data">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtDescripcionNivel" placeholder="Descripción" MaxLength="50" onkeydown="return (event.keyCode!=13);" class="form-control" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-lg-10">Habilitar evaluación</label>
                                <asp:CheckBox runat="server" ID="chkEvaluacion" CssClass="chkIphone" Width="30px" Text="Activo" Checked="True" />
                            </div>
                            <div class="form-group">
                                Artículo<br />
                            ...
                            <div class="form-group">
                                <label class="col-lg-10">Público</label>
                        ...
                        <div runat="server" id="divStep2Data" visible="False">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionArea" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionN1" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
                            ...
                            <div class="form-group" runat="server" id="divNivel2" visible="False">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionN2" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
                            ...
                            <div class="form-group" runat="server" id="divNivel3" visible="False">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionN3" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
                            ...
                            <div class="form-group" runat="server" id="divNivel4" visible="False">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionN4" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
                            ...
                            <div class="form-group" runat="server" id="divNivel5" visible="False">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionN5" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
                            ...
                            <div class="form-group" runat="server" id="divNivel6" visible="False">
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtDescripcionN6" runat="server" onkeydown="return (event.keyCode!=13 && event.keyCode!=27);" MaxLength="50" style="margin-top: 10px; opacity: 0.5;"/>
