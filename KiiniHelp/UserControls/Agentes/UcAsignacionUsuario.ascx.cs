    ...
    public partial class UcAsignacionUsuario : UserControl, IControllerModal
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //btnSeleccionarUsuario.OnClientClick = "this.disabled = document.getElementById('form1').checkValidity(); if(document.getElementById('form1').checkValidity()){ " + Page.ClientScript.GetPostBackEventReference(btnSeleccionarUsuario, null) + ";}";  
                if (!IsPostBack)
                {
