        ...
        protected void btnGraficar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtFechaInicio.Text.Trim() == string.Empty || txtFechaFin.Text.Trim() == string.Empty)
                    path = "Users/ReportesGraficos/Encuestas/FrmGraficoEncuestaNPS.aspx?idArbol=" + int.Parse(((LinkButton)sender).CommandArgument) + "&tipoFecha=" + ddlTipoFiltro.SelectedValue;
                else
                {
                    ...
                    path = "Users/ReportesGraficos/Encuestas/FrmGraficoEncuestaNPS.aspx?idArbol=" + int.Parse(((LinkButton)sender).CommandArgument) + "&tipoFecha=" + ddlTipoFiltro.SelectedValue + "&fi=" + txtFechaInicio.Text + "&ff=" + txtFechaFin.Text;
                }
