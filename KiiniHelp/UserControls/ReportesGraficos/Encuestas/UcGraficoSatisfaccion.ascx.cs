...
{
    public partial class UcGraficoSatisfaccion : UserControl
    {
        ...
        private void LLenaDatos(int idArbol, int idTipoFecha, string fechaInicio, string fechafin)
        {
            try
            {
                ...
                HelperReporteEncuesta reporte = _servicioEncuesta.ObtenerGraficoSatisfaccion(idArbol, Metodos.ManejoFechas.ObtenerFechas(idTipoFecha, fechaInicio, fechafin), idTipoFecha);
        ...
        protected void btnDownload_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.Params["idArbol"] != null && Request.Params["tipoFecha"] != null && Request.Params["fi"] != null && Request.Params["ff"] != null)
                {
                    dtDatos = _servicioEncuesta.ObtenerGraficoSatisfaccionDescarga(int.Parse(Request.Params["idArbol"]), Metodos.ManejoFechas.ObtenerFechas(int.Parse(Request.Params["tipoFecha"]), Request.Params["fi"], Request.Params["ff"]));
                }
                else if (Request.Params["idArbol"] != null && Request.Params["tipoFecha"] != null)
                    dtDatos = _servicioEncuesta.ObtenerGraficoSatisfaccionDescarga(int.Parse(Request.Params["idArbol"]), Metodos.ManejoFechas.ObtenerFechas(int.Parse(Request.Params["tipoFecha"]), string.Empty, string.Empty));

                Response.Clear();
                MemoryStream ms = new MemoryStream(BusinessFile.ExcelManager.DatatableToExcel(dtDatos).GetAsByteArray());

                Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
                Response.AddHeader("content-disposition", "attachment;  filename=GraficoEncuestaSatisfaccion.xlsx");
