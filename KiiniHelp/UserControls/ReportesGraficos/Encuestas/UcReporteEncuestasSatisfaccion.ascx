<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcReporteEncuestasSatisfaccion.ascx.cs" Inherits="KiiniHelp.UserControls.ReportesGraficos.Encuestas.UcReporteEncuestasSatisfaccion" %>
    ...
    <asp:UpdatePanel runat="server" class="heigth100">
        <ContentTemplate>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Encuesta Satisfacción</li>
            </ol>
                        ...
                        <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            <div class="module-heading">
                                <h3 class="module-title">
                                    <asp:Label runat="server" ID="lblSeccion" Text="Encuesta Satisfacción" /></h3>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView runat="server" ID="tblResults" AllowPaging="true" AutoGenerateColumns="false" Width="99%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Pésimo" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Pesimo")%>'><%# Eval("Pesimo")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Malo" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Malo")%>'><%# Eval("Malo")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Regular" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Regular")%>'><%# Eval("Regular")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Bueno" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Bueno")%>'><%# Eval("Bueno")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Excelente" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Excelente")%>'><%# Eval("Excelente")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
