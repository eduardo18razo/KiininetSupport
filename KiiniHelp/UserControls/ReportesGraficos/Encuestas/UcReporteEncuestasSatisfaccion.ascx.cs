...
{
    public partial class UcReporteEncuestasSatisfaccion : UserControl
    {
        #region Variables
        ...
        private void LlenaArboles()
        {
            try
            {
                ...
                List<ArbolAcceso> lstArboles = _servicioArbolAcceso.ObtenerArbolesAccesoAllReporte(idArea, idTipoUsuario, null, (int)BusinessVariables.EnumTipoEncuesta.CalificacionPesimoMaloRegularBuenoExcelente, Metodos.ManejoFechas.ObtenerFechas(int.Parse(ddlTipoFiltro.SelectedValue), txtFechaInicio.Text.Trim(), txtFechaFin.Text.Trim())).Where(w => w.EsTerminal).ToList();
        ...
        protected void btnGraficar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtFechaInicio.Text.Trim() == string.Empty || txtFechaFin.Text.Trim() == string.Empty)
                    path = "Users/ReportesGraficos/Encuestas/FrmGraficoEncuestaSatisfaccion.aspx?idArbol=" + int.Parse(((LinkButton)sender).CommandArgument) + "&tipoFecha=" + ddlTipoFiltro.SelectedValue;
                else
                {
                    ...
                    path = "Users/ReportesGraficos/Encuestas/FrmGraficoEncuestaSatisfaccion.aspx?idArbol=" + int.Parse(((LinkButton)sender).CommandArgument) + "&tipoFecha=" + ddlTipoFiltro.SelectedValue + "&fi=" + txtFechaInicio.Text + "&ff=" + txtFechaFin.Text;
                }
