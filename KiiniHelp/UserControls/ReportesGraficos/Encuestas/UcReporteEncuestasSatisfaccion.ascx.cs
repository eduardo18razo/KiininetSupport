    ...
    public partial class UcReporteEncuestasSatisfaccion : UserControl
    {
        ...
        private void LlenaArboles()
        {
            try
            {
                ...
                List<ArbolAcceso> lstArboles = _servicioArbolAcceso.ObtenerArbolesAccesoAllReporte(idArea, idTipoUsuario, null, (int)BusinessVariables.EnumTipoEncuesta.CalificacionPesimoMaloRegularBuenoExcelente, ucFiltroFechasGrafico.RangoFechas).Where(w => w.EsTerminal).ToList();
        ...
        protected void btnGraficar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ucFiltroFechasGrafico.RangoFechas == null)
                    path = "Users/ReportesGraficos/Encuestas/FrmGraficoEncuestaSatisfaccion.aspx?idArbol=" + int.Parse(((LinkButton)sender).CommandArgument) + "&tipoFecha=" + ucFiltroFechasGrafico.TipoPeriodo;
                else
                {
                    path = "Users/ReportesGraficos/Encuestas/FrmGraficoEncuestaSatisfaccion.aspx?idArbol=" + int.Parse(((LinkButton)sender).CommandArgument) + "&tipoFecha=" + ucFiltroFechasGrafico.TipoPeriodo + "&fi=" + ucFiltroFechasGrafico.FechaInicio + "&ff=" + ucFiltroFechasGrafico.FechaFin;
                }
