<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcConsultaUsuariosAgente.ascx.cs" Inherits="KiiniHelp.UserControls.Consultas.UcConsultaUsuariosAgente" %>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Verificado" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton runat="server" CommandArgument='<%# Eval("Id")%>' ID="btnReenviar" OnClick="btnReenviar_OnClick" Visible='<%# !(bool) Eval("Activo") %>'>Reenviar</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
