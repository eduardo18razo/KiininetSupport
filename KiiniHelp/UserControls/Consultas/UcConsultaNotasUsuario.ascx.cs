...
{
    public partial class UcConsultaNotasUsuario : UserControl
    {
        ...
        private void LlenaNotasConsulta(string filtro = "")
        {
            try
            {
                List<HelperNotasUsuario> notas = _servicioNotas.ObtenerNotasUsuario(((Usuario)Session["UserData"]).Id, false);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ucAltaNota.OnAceptarModal += AltaNotaOnAceptarModal;
                ucAltaNota.OnCancelarModal += AltaNotaOnCancelarModal;
                LlenaNotasConsulta();
            }
            catch (Exception ex)
            {
