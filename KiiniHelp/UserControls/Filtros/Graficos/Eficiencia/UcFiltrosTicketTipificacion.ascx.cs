...
{
    public partial class UcFiltrosTicketTipificacion : UserControl, IControllerModal
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    ucFiltroTipificacion.TipoArbol = new List<int> { (int)BusinessVariables.EnumTipoArbol.SolicitarServicio, (int)BusinessVariables.EnumTipoArbol.ReportarProblemas };
                }
            }
            catch (Exception ex)
            {
