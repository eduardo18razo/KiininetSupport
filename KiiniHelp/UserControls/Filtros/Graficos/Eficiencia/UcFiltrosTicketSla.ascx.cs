...
{
    public partial class UcFiltrosTicketSla : UserControl, IControllerModal
    {
        ...
        {
            get { return (int)BusinessVariables.EnumGraficos.ReporteDentroFueraSla; }
        ...
        {
            IdReporte = (int)BusinessVariables.EnumGraficos.ReporteDentroFueraSla;
        }
