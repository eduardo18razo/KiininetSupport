<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcFiltrosTicketOrganizacion.ascx.cs" Inherits="KiiniHelp.UserControls.Filtros.Graficos.Eficiencia.UcFiltrosTicketOrganizacion" %>
