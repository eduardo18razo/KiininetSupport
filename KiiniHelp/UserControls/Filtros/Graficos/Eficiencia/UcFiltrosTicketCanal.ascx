<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcFiltrosTicketCanal.ascx.cs" Inherits="KiiniHelp.UserControls.Filtros.Graficos.Eficiencia.UcFiltrosTicketCanal" %>
