<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcFiltrosTicketEstatusAtencion.ascx.cs" Inherits="KiiniHelp.UserControls.Filtros.Graficos.Eficiencia.UcFiltrosTicketEstatusAtencion" %>
