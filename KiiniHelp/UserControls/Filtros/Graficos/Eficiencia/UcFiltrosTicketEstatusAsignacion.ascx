<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcFiltrosTicketEstatusAsignacion.ascx.cs" Inherits="KiiniHelp.UserControls.Filtros.Graficos.Eficiencia.UcFiltrosTicketEstatusAsignacion" %>
