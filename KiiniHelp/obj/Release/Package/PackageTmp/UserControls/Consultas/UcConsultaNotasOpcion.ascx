<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcConsultaNotasOpcion.ascx.cs" Inherits="KiiniHelp.UserControls.Consultas.UcConsultaNotasOpcion" %>
<%@ Register Src="~/UserControls/Altas/UcAltaNotaOpcion.ascx" TagPrefix="uc1" TagName="UcAltaNotaOpcion" %>
            ...
            <ContentTemplate>
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <uc1:UcAltaNotaOpcion runat="server" id="ucAltaNotaOpcion" />
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
