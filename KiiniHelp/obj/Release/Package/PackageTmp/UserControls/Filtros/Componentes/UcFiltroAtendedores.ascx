...
<asp:UpdatePanel runat="server" UpdateMode="Conditional">
    <ContentTemplate>
                ...
                <asp:Repeater runat="server" ID="rptUsuarios">
                    <HeaderTemplate>
                        <div class="container-fluid">
                            ...
                            <asp:Label CssClass="col-sm-5 text-center" runat="server" ID="lblDescripcion" Text="Nombre" />
                        </div>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <div class="container-fluid" style="margin-top: 2px">
                            ...
                            <asp:Label CssClass="col-sm-6" runat="server" ID="lblDescripcion" Text='<%# Eval("NombreCompleto") %>' />
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <asp:Repeater runat="server" ID="rptUsuarioSeleccionado">
                    <HeaderTemplate>
                        <div class="container-fluid">
                            <asp:Label CssClass="col-sm-1 text-center" runat="server" Text="TipoUsuario" />
                            <asp:Label CssClass="col-sm-5 text-center" runat="server" Text="Nombre" />
                        </div>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <div class="container-fluid" style="margin-top: 2px">
