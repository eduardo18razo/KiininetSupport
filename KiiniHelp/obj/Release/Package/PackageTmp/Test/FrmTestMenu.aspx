<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTestMenu.aspx.cs" Inherits="KiiniHelp.Test.FrmTestMenu" %>
        ...
        <header class="header">
            <div class="branding float-left">
                <h1 class="logo text-center">
                    <a href="index.html">
                        <img class="logo-icon" src="../on/images/logo-icon.svg" alt="icon" />
                ...
                <div class="search-container">
                    <form id="main-search" class="main-search">
                        ...
                        <div id="main-search-input-wrapper" class="main-search-input-wrapper">
                            <asp:TextBox runat="server" type="text" id="main_search_input" class="main-search-input form-control" placeholder="Buscar por palabra clave..."/>
                ...
                <div class="navbar-tools">
                    ...
                    <div class="user-container dropdown">
                        <div class="dropdown-toggle" id="dropdownMenu-user" data-toggle="dropdown" aria-expanded="true" role="button">
                            <img src="../on/images/profiles/profile-1.png" alt="" />
                            ...
                            <div class="carousel slide bootstrap-carousel" data-ride="carousel" id="carousel-example-generic">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="../on/images/carousels/slide-1.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="../on/images/carousels/slide-2.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="../on/images/carousels/slide-3.jpg" alt="">
                                    </div>
                                </div>
                                <!-- Controls -->
                                ...
                                <div class="module-content collapse in" id="content-2">
                                    <div class="module-content-inner">
                                        <a href="user_select.html">
                                            <img class="img-responsive margin-left" src="../on/images/users_icon/usuario_2.jpg" alt="Iconos de usuarios" /></a>
                        ...
                        <section class="module project-module">
                            <div class="module-inner">
                                <div class="module-content collapse in" id="content-2">
                                    <div class="module-content-inner">
                                        <a href="user_select.html">
                                            <img class="img-responsive  margin-left" src="../on/images/users_icon/cliente.jpg" alt="Iconos de usuarios" /></a>
                        ...
                        <section class="module project-module">
                            <div class="module-inner">
                                <div class="module-content collapse in" id="content-2">
                                    <div class="module-content-inner">
                                        <a href="user_select.html">
                                            <img class="img-responsive  margin-left" src="../on/images/users_icon/usuario_3.jpg" alt="Iconos de usuarios" /></a>
