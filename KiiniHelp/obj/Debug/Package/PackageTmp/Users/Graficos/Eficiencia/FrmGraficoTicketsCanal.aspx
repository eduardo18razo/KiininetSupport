<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios.Master" AutoEventWireup="true" CodeBehind="FrmGraficoTicketsCanal.aspx.cs" Inherits="KiiniHelp.Users.Graficos.Eficiencia.FrmGraficoTicketsCanal" %>

<%@ Register Src="~/UserControls/Detalles/UcDetalleGeograficoTickets.ascx" TagPrefix="uc1" TagName="UcDetalleGeograficoTickets" %>

<%@ Register Src="~/UserControls/Filtros/Graficos/Eficiencia/UcFiltrosTicketCanal.ascx" TagPrefix="uc1" TagName="UcFiltrosTicketCanal" %>
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <ol class="breadcrumb">
                ...
                <li class="active">Tickets: Canal</li>
            </ol>
                        ...
                        <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            <div class="module-heading">
                                <h3 class="module-title">
                                    <asp:Label runat="server" ID="lblSeccion" Text="Tickets: Canal" /></h3>
                            </div>
                            <p>
                                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <uc1:UcFiltrosTicketCanal runat="server" ID="ucFiltrosTicketCanal" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </p>
                        </div>
