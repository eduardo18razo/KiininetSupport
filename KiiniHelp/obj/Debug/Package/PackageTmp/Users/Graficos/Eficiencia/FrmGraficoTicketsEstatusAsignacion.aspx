<%@ Page Title="" Language="C#" MasterPageFile="~/Usuarios.Master" AutoEventWireup="true" CodeBehind="FrmGraficoTicketsEstatusAsignacion.aspx.cs" Inherits="KiiniHelp.Users.Graficos.Eficiencia.FrmGraficoTicketsEstatusAsignacion" %>
...
<%@ Register Src="~/UserControls/Filtros/Graficos/Eficiencia/UcFiltrosTicketEstatusAsignacion.ascx" TagPrefix="uc1" TagName="UcFiltrosTicketEstatusAsignacion" %>
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <ol class="breadcrumb">
                    ...
                    <li>Graficos</li>
                    <li class="active">Tickets: Estatus de ASignación</li>
                </ol>
                            ...
                            <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                                <div class="module-heading">
                                    <h3 class="module-title">
                                        <asp:Label runat="server" ID="lblSeccion" Text="Tickets: Estatus de ASignación" /></h3>
                                </div>
                                <p>
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <uc1:UcFiltrosTicketEstatusAsignacion runat="server" id="ucFiltrosTicketEstatusAsignacion" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </p>
                            </div>
