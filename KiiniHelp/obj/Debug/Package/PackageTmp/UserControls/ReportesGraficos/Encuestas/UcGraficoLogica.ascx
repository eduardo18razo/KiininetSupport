<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcGraficoLogica.ascx.cs" Inherits="KiiniHelp.UserControls.ReportesGraficos.Encuestas.UcGraficoLogica" %>
    ...
    <asp:UpdatePanel runat="server" class="heigth100">
        <ContentTemplate>
            ...
            <ol class="breadcrumb">
                ...
                <li>Help Center</li>
                <li class="active">Grafico Eficiencia Logica</li>
            </ol>
