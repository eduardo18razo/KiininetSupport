                        ...
                        <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            <div class="module-heading">
                                <h3 class="module-title">
                                    <asp:Label runat="server" ID="lblSeccion" Text="Encuesta NPS (Net Promoter Score)" /></h3>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView runat="server" ID="tblResults" AllowPaging="true" AutoGenerateColumns="false" Width="99%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Promotores" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Promotores")%>'><%# Eval("Promotores")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Neutros" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Neutros")%>'><%# Eval("Neutros")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Detractores" HeaderStyle-Width="15%">
                                            <ItemTemplate>
                                                <label runat="server" class="ocultaTexto" title='<%# Eval("Detractores")%>'><%# Eval("Detractores")%></label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
