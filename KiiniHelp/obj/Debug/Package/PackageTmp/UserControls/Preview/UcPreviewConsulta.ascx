<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcPreviewConsulta.ascx.cs" Inherits="KiiniHelp.UserControls.Preview.UcPreviewConsulta" %>
                        ...
                        <asp:Repeater runat="server" ID="rptArchivos">
                            <ItemTemplate>
                                <div class="row">
                                    ...
                                    <asp:HyperLink runat="server" Enabled="False" Text="Download" NavigateUrl='<%# ResolveUrl(string.Format("~/Downloads/FrmDownloads.aspx?file={0}", BusinessVariables.Directorios.RepositorioTemporalInformacionConsulta + "~" + Eval("NombreArchivo"))) %>'></asp:HyperLink>
                                    <asp:LinkButton runat="server" Text="Preview" ID="btnPreviewDocument" CssClass="margin-left-5" CommandArgument='<%# Eval("NombreArchivo") %>' OnClick="btnPreviewDocument_OnClick" Enabled="False"></asp:LinkButton>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
