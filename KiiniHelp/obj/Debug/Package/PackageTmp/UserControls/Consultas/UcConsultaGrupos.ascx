                ...
                <div class="row">
                    <div class="module-inner">
                        <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p>
                                Un grupo está conformado por un conjunto de usuarios (usuarios finales y agentes) que tienen privilegios comunes sobre las funciones dentro de su cuenta. El rol es la función que desempeña un usuario. Los usuarios deben estar asignados a por lo menos un grupo, pero pueden pertenecer a más de uno. Es importante tomar en cuenta que: 1) un grupo está ligado únicamente a un rol, 2) varios grupos pueden estar ligandos al mismo rol, 3) un usuario puede tener más de un rol y 4) un usuario puede pertenecer a más de un Grupo, solamente si tiene dicho rol.                            
                            </p>
                        </div>
