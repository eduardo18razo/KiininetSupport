                        ...
                        <asp:Repeater runat="server" ID="rptGpos">
                            <HeaderTemplate>
                                <div class="container-fluid" >
                                    <asp:Label CssClass="col-sm-1 text-center" runat="server" ID="lblTipoEmpleado" Text="TU"  style="text-align: left"/>
                                    <asp:Label CssClass="col-sm-3 text-center" runat="server" ID="lblTipoGrupo" Text="Tipo Grupo" style="text-align: left" />
                                    <asp:Label CssClass="col-sm-6 text-center" runat="server" ID="lblDescripcion" Text="Grupo" style="text-align: left" />  
                                </div>
                            </HeaderTemplate>
                            <ItemTemplate>
                ...
                <asp:Panel runat="server" ScrollBars="Vertical" Width="100%" Height="140px">
                    <div class="panel-body">
                        <asp:Repeater runat="server" ID="rptGpoSeleccionado">
                            <HeaderTemplate>
                                <div class="container-fluid">
                                    <asp:Label CssClass="col-sm-1 text-center" runat="server" Text="TU" style="text-align: left" />
                                    <asp:Label CssClass="col-sm-3 text-center" runat="server" ID="lblTipoGrupo" Text="Tipo Grupo" style="text-align: left" />
                                    <asp:Label CssClass="col-sm-6 text-center" runat="server" Text="Grupo"  style="text-align: left"/>
                            ...
                            <ItemTemplate>
                                <div class="container-fluid" style="margin-top: 2px">
                                   ...
                                   <%-- <asp:HiddenField runat="server" Value='<%# Eval("TipoUsuario.Color") %>' /> --%>
                                    <asp:Label CssClass="col-sm-3" runat="server" ID="lblTipoGrupoDes" Text='<%# Eval("TipoGrupo.Descripcion") %>' />
                                    <asp:Label CssClass="col-sm-6" runat="server" ID="lblDescripcion" Text='<%# Eval("Descripcion") %>' />
