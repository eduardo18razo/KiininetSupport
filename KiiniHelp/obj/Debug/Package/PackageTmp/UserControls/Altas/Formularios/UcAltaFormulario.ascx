                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="module-inner no-padding-left" style="border-bottom: 1px solid #000000; border-bottom: 1px solid rgba(0, 0, 0, .2);">
                                                    ...
                                                    <div class="form-inline">
                                                        <div class="form-group">
                                                            <asp:LinkButton runat="server" Text="Editar" ID="btnEditarCampo" OnClick="btnEditarCampo_OnClick" /><asp:Label runat="server" ID="lblSeparador" Text="|"></asp:Label> <asp:LinkButton runat="server" Text="borrar" ID="btnEliminarCampo" OnClick="btnEliminarCampo_OnClick" />
                                                        </div>
                                                        <div class="form-group">
                            ...
                            <div class="col-lg-12 col-md-12" runat="server" id="divCatalgo" visible="False">
                                <div class="module-inner">
                                    <div class="form-group">
                                        ...
                                        <br />
                                        <hr />
                                        Agregar registros manualmente:<br />
