<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcAltaNota.ascx.cs" Inherits="KiiniHelp.UserControls.Altas.UcAltaNota" %>
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <asp:DropDownList runat="server" AutoPostBack="True" CssClass="DropSelect" ID="ddlTipoNota" OnSelectedIndexChanged="ddlTipoNota_OnSelectedIndexChanged"/>
                        </div>
                    </div>
                    <div class="form-group" runat="server" ID="divTipoArbol" Visible="False">
