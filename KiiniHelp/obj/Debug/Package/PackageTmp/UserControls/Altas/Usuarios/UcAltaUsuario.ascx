                                                                                    ...
                                                                                    <asp:Repeater runat="server" ID="rptSubGrupos">
                                                                                        ...
                                                                                        <ItemTemplate>
                                                                                            <div style="font-weight: 200; padding-left: 40px;" class="text-left">
                                                                                                <br />
                                                                                                <%# Eval("Descripcion") %>
                                                                                                <asp:LinkButton runat="server" class="remove glyphicon glyphicon-remove glyphicon-white" ID="btnRemoveRolSub" OnClick="btnRemoveRolSub_OnClick" CommandName='<%# Container.ItemIndex %>' CommandArgument='<%# Eval("Id") %>' />
                                                                                            </div>
                                                                                        </ItemTemplate>
                                                                                    </asp:Repeater>
