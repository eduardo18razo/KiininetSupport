        ...
        <asp:UpdatePanel ID="upGeneral" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="panel panel-primary" style="width: 600px; margin: 0 auto">
                    <div style="padding:0px 20px"> <%--class="panel-heading"--%>
                        ...
                        <div class="form-horizontal">
                                ...
                                <asp:Repeater runat="server" ID="rptConfirmacion" >
                                    <ItemTemplate>
                                        <div class="form-group">
                                            ...
                                            <table>
                                                 <tr>
                                                    <td colspan="3" style="padding-right:50px; text-align:left">
                                                       <br />
                            ...
                            <%--<div class="form-inline">--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Label ID="Label4" runat="server" Text="Pregunta" class="col-sm-4 control-label" />
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label5" runat="server" Text="Respuesta" class="col-sm-4 control-label"></asp:Label>
                                    <div class="col-sm-7">
                    ...
                    <div class="center-content-div"> <%--panel-footer--%> 
